...
public class CreditAccount extends Account {
  ...
  private final static int DEFAULT_TYPE_ID = AccountType.TypeIdentifier.CREDIT_TYPE.getId();
  ...
  public static class Builder
      extends Account.AbstractBuilder<CreditAccount.Builder, CreditAccount> {
    ...
    public CreditAccount.Builder addDefaultAccountType() {
      creditAccount.setAccountType(new AccountType(DEFAULT_TYPE_ID, DEFAULT_TYPE));
      return this;
    }
    ...
    public CreditAccount.Builder addInterestRate(double interestRate) {
