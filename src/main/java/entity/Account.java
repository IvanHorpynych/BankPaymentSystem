...
public class Account {
  ...
  private final static int DEFAULT_TYPE_ID = AccountType.TypeIdentifier.DEBIT_TYPE.getId();

  public final static String DEFAULT_STATUS = "ACTIVE";
  private final static int DEFAULT_STATUS_ID = Status.StatusIdentifier.ACTIVE_STATUS.getId();
  ...
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T, A>, A extends Account> {
    ...
    public T addDefaultAccountType() {
      getAccount().setAccountType(new AccountType(DEFAULT_TYPE_ID, DEFAULT_TYPE));
      return getThis();
    }
    ...
    public T addDefaultStatus() {
      getAccount().setStatus(new Status(DEFAULT_STATUS_ID, DEFAULT_STATUS));
      return getThis();
    }
  ...
  public String toString() {
    return "Account{" + "accountNumber=" + accountNumber + ", user=" + accountHolder + ", type="
