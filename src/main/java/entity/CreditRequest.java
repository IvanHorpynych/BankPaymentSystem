...
public class CreditRequest {
  ...
  private final static int DEFAULT_STATUS_ID = Status.StatusIdentifier.PENDING_STATUS.getId();
  ...
  public static class Builder {
    ...
    public Builder addDefaultStatus() {
      creditRequest.setStatus(new Status(DEFAULT_STATUS_ID, DEFAULT_STATUS));
      return this;
    }
  ...
  public String toString() {
    return "CreditRequest{" + "requestNumber=" + requestNumber + ", holder=" + accountHolder
        + ", creditLimit=" + creditLimit + ", interestRate=" + interestRate + ", status=" + status
