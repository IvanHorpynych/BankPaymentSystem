...
public class DepositAccount extends Account {
  ...
  private final static int DEFAULT_TYPE_ID = AccountType.TypeIdentifier.DEPOSIT_TYPE.getId();
  ...
  public static class Builder extends Account.AbstractBuilder<Builder, DepositAccount> {
    ...
    public DepositAccount.Builder addDefaultAccountType() {
      depositAccount.setAccountType(new AccountType(DEFAULT_TYPE_ID, DEFAULT_TYPE));
      return this;
    }
