...
import dao.util.card.CardTypeConverter;
...
public class Card {
  ...
  public static class Builder {
    ...
    public Builder addDefaultStatus() {
      card.setStatus(new Status(DEFAULT_STATUS_ID, DEFAULT_STATUS));
      return this;
    }
  ...
  public String toString() {
    return "Card{" + "cardNumber=" + cardNumber + ", accountId=" + getAccount() + ", pin=" + pin
        + ", cvv=" + cvv + ", expireDate=" + expireDate + ", type=" + type.toString() + ", status="
        + status + '}';
  }
