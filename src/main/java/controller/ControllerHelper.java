...
public class ControllerHelper {
  ...
  private void init() {
    commands.put(buildKey(bundle.getString("home.path"), null), new HomeCommand());
    commands.put(buildKey(bundle.getString("home.path"), "home"), new HomeCommand());
    commands.put(buildKey(bundle.getString("login.path"), null), new GetLoginCommand());
    commands.put(buildKey(bundle.getString("signup.path"), null), new GetSignupCommand());
    commands.put(buildKey(bundle.getString("login.path"), "login.post"), new PostLoginCommand());
    commands.put(buildKey(bundle.getString("signup.path"), "signup.post"), new PostSignupCommand());
    commands.put(buildKey(bundle.getString("logout.path"), "logout"), new LogoutCommand());
    commands.put(buildKey(bundle.getString("user.info"), null), new GetInfoCommand());
    ...
    commands.put(buildKey(bundle.getString("user.card.path"), null), new GetCardsCommand());
    ...
    commands.put(buildKey(bundle.getString("manager.users.list"), null), new GetUsersCommand());
    ...
    commands.put(buildKey(bundle.getString("manager.rate.path"), null), new GetAnnualRateCommand());
  ...
  public static class Singleton {
    private final static ControllerHelper INSTANCE = new ControllerHelper();
