...
public class MySqlRateDao implements RateDao {
  private final static String SELECT = "SELECT ANNUAL_RATE, CREATED_TIME FROM CURR_ANNUAL_RATE ";

  private final static String INSERT = "INSERT INTO CURR_ANNUAL_RATE (ANNUAL_RATE) " + "VALUES(?);";
  ...
  private final static String LAST_INSERTED = "ORDER BY CREATED_TIME DESC ";
  ...
  public MySqlRateDao(Connection connection, DtoConverter<Rate> converter) {
  ...
  public Rate insert(Rate obj) {
    ...
    int id = (int) defaultDao.executeInsertWithGeneratedPrimaryKey(INSERT, obj.getAnnualRate());
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      Rate accountType = mySqlRateDao.insert(new Rate(13.4f, new Date()));
      ((MySqlRateDao) mySqlRateDao).printAll(mySqlRateDao.findAll());
