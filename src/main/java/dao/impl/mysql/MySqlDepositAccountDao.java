...
public class MySqlDepositAccountDao implements DepositAccountDao {
  private final static String SELECT_ALL = "SELECT * FROM deposit_details ";
  ...
  private final static String INSERT_DETAILS =
      "INSERT INTO deposit_account_details " + "(id, annual_rate) " + "VALUES(?, ?) ";

  private final static String UPDATE =
      "UPDATE deposit_account_details SET " + "last_operation = ?, " + "min_balance = ? ";

  private final static String UPDATE_STATUS = "UPDATE account SET " + "status_id = ? ";

  private final static String UPDATE_MIN_BALANCE =
      "UPDATE deposit_account_details SET " + "min_balance = ? ";
  ...
  private final static String DELETE = "DELETE details, account FROM "
      + "deposit_account_details AS details " + "JOIN account  USING(id) ";
  ...
  public MySqlDepositAccountDao(Connection connection, DtoConverter<DepositAccount> converter) {
  ...
  public DepositAccount insert(DepositAccount account) {
    ...
    defaultDao.executeUpdate(INSERT_DETAILS, account.getAccountNumber(), account.getAnnualRate());
  ...
  public void update(DepositAccount account) {
    ...
    defaultDao.executeUpdate(UPDATE + WHERE_ACCOUNT_NUMBER,
        TimeConverter.toTimestamp(account.getLastOperationDate()), account.getMinBalance(),
  ...
  public void updateMinBalance(DepositAccount account, BigDecimal minBalance) {
    ...
    defaultDao.executeUpdate(UPDATE_MIN_BALANCE + WHERE_ACCOUNT_NUMBER, minBalance,
        account.getAccountNumber());
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ((MySqlDepositAccountDao) mySqlDepositAccountDao)
