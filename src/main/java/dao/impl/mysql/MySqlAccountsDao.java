...
public class MySqlAccountsDao implements AccountsDao {
  ...
  private final static String MAIN_QUERY = "SELECT * FROM account_details ";
  ...
  private final static String WHERE_TYPE = "WHERE type_id = ? ";

  private final static String INSERT =
      "INSERT INTO account " + "(user_id, type_id, status_id, balance) " + "VALUES(?, ?, ?, ?) ";


  private final static String UPDATE = "UPDATE account SET " + "balance = ? ";
  ...
  private final static String DELETE = "DELETE FROM account ";
  ...
  public MySqlAccountsDao(Connection connection, DtoConverter<Account> converter, String query) {
  ...
  public void update(Account account) {
     ...
     * Objects.requireNonNull(account);
     * 
     * defaultDao.executeUpdate( UPDATE + WHERE_ACCOUNT_NUMBER, account.getBalance(),
