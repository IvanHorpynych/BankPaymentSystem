...
public class MySqlRoleDao implements RoleDao {
  private final static String SELECT_ALL =
      "SELECT id AS role_id, name AS role_name " + "FROM role ";

  private final static String INSERT = "INSERT INTO role (name) " + "VALUES(?);";

  private final static String UPDATE = "UPDATE role SET name = ? ";

  private final static String DELETE = "DELETE FROM role ";
  ...
  public MySqlRoleDao(Connection connection, DtoConverter<Role> converter) {
  ...
  public Role insert(Role role) {
    ...
    int id = (int) defaultDao.executeInsertWithGeneratedPrimaryKey(INSERT, role.getName());
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ((MySqlRoleDao) mySqlRoleDao).printAll(mySqlRoleDao.findAll());
      System.out.println();
      ...
      Role accountType = mySqlRoleDao.insert(new Role(0, "TEST"));
      ((MySqlRoleDao) mySqlRoleDao).printAll(mySqlRoleDao.findAll());
