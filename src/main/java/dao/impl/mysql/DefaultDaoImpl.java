...
public class DefaultDaoImpl<T> {
  private final static String ERROR_GENERATE_KEY = "Can't retrieve generated key";
  ...
  /**
   * Performs insertion for entities with generated primary key field. For entities, which doesn't
   * have auto-generated fields - use {@link #executeUpdate(String, Object...)} method to properly
   * persist data.
   *
  ...
  /**
   * Get from resultSet generated by database primary key. Use only after execution statement.
