...
public class MySqlUserDao implements UserDao {
  private final static String SELECT_ALL = "SELECT user.id AS user_id, user.role_id,"
  ...
  private final static String WHERE_ID = "WHERE user.id = ? ";

  private final static String WHERE_EMAIL = "WHERE user.email = ? ";

  private final static String INSERT = "INSERT into user (role_id, first_name, last_name,"
      + "email, phone_number, password)" + "VALUES(?, ?, ?, ?, ?, ?) ";

  private final static String UPDATE = "UPDATE user SET " + "first_name = ?, "
      + "last_name = ?, email = ?, " + "phone_number = ?, password = ? ";

  private final static String DELETE = "DELETE FROM user ";
  ...
  public MySqlUserDao(Connection connection, DtoConverter<User> converter) {
  ...
  public User insert(User obj) {
    ...
    int id = (int) defaultDao.executeInsertWithGeneratedPrimaryKey(INSERT, obj.getRole().getId(),
        obj.getFirstName(), obj.getLastName(), obj.getEmail(), obj.getPhoneNumber(),
        obj.getPassword());
  ...
  public void update(User obj) {
    ...
    defaultDao.executeUpdate(UPDATE + WHERE_ID, obj.getFirstName(), obj.getLastName(),
        obj.getEmail(), obj.getPassword(), obj.getPhoneNumber(), obj.getId());
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      User insertUser = mySqlUserDao
          .insert(User.newBuilder().addFirstName("first" + random).addLastName("last" + random)
