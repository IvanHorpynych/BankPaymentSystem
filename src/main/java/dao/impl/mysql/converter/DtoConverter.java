...
public interface DtoConverter<T> {
   ...
   */
  default List<T> convertToObjectList(ResultSet resultSet) throws SQLException {
   ...
   * @throws SQLException
   */
  default List<T> convertToObjectList(ResultSet resultSet, String tablePrefix) throws SQLException {
