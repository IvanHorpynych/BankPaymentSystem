...
public class HibernateCreditRequestDao implements CreditRequestDao {
  ...
  public List<CreditRequest> findByStatus(long statusId) {
    try (Session session = HibernateUtil.getInstance()) {
      Query query = session.createQuery("from CreditRequest where status.id = :statusId",
          CreditRequest.class);
  ...
  public static void main(String[] args) {
    ...
    HibernateCreditRequestDao mySqlCreditRequestDao = new HibernateCreditRequestDao();
